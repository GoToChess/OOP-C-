...
void cpu::easy_diff(Piece Matrix[8][8])
{
	...
	while (1)
	{
		...
		if(param1 == 'W')
		{
			...
			if (o.moveLegal(r1, r2, r3, r4, Matrix))
			{
				...
				cout << "Source: " << r1 << "," << r2 << "   Destination: " << r3 << "," << r4 << endl;
				break;
			...
			for (int k = 0; k < 8; k++) {
				for (int l = 0; l < 8; l++) {
					...
					case 'W':
						...
						if (o.moveLegal(i, j, k, l, array) && !state)
						{
						...
						if (o.incheck('B', array))
						{
							cout << "Source: " << i << "," << j << "   Destination: " << k << "," << l << endl;
				...
				for (int f = 0; f < 8; f++) {
						...
						if (param1 == 'W' && param2 == 'B')
						{
							...
							if (o.moveLegal(c, d, e, f, array)) 
							{
								...
								cout << "Source: " << c << "," << d << "   Destination: " << e << "," << f << endl;
								c = d = e = f = 7;
